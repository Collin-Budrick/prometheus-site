...
- Generate SQL from Drizzle schema: `pnpm -C apps/api db:generate`
- Migrate: `pnpm -C apps/api db:migrate`
- Seed: `pnpm -C apps/api db:seed`
- Studio: `pnpm -C apps/api db:studio`
...
## Testing and quality
- `pnpm lint` (Biome across web + api)
- `pnpm test` placeholder (wire up framework tests as features grow)
