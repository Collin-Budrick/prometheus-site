...
Monorepo for the Fragment Prime site (`apps/site`) and API (`packages/platform`) with Bun and Qwik.
...
- Ports: `4000` API, `3000` SpaceTimeDB, `6379` Garnet, `4444` webtransport, `4173` device web
