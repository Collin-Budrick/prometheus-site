...
const emptyGroups: ContactInviteGroups = {
  incoming: [],
  outgoing: [],
  contacts: []
}
...
const normalizeInviteGroups = (value: unknown): ContactInviteGroups => {
  if (!isRecord(value)) return emptyGroups
  return {
...
export const ContactInvites = component$<ContactInvitesProps>((props) => {
  ...
  const invites = useSignal<ContactInviteGroups>(emptyGroups)
