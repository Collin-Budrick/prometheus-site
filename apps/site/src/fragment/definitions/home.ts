...
const dockIconSvgStyle = 'width:100%;height:100%;display:block;'

const DockIcons = {
  gitHub: (props: IconProps = {}) =>
    createElement(
      'svg',
      { viewBox: '0 0 438.549 438.549', ...props },
      createElement('path', {
        fill: 'currentColor',
    ...
    createElement(
      ...
      createElement(
        ...
        createElement(
          ...
          createElement('stop', { offset: '0', stopColor: '#57d163' }),
          createElement('stop', { offset: '1', stopColor: '#23b33a' })
        ),
        createElement(
          'filter',
          {
...
const renderDockIcon = (label: string, icon: ReturnType<(typeof DockIcons)[keyof typeof DockIcons]>) =>
  createElement(
    'div',
    {
      className:
      ...
      createElement(
        ...
        createElement(
          ...
          createElement(
            ...
            [
              renderDockIcon('GitHub', DockIcons.gitHub({ style: dockIconSvgStyle, 'aria-hidden': 'true' })),
              renderDockIcon('Google Drive', DockIcons.googleDrive({ style: dockIconSvgStyle, 'aria-hidden': 'true' })),
              renderDockIcon('Notion', DockIcons.notion({ style: dockIconSvgStyle, 'aria-hidden': 'true' })),
              renderDockIcon('WhatsApp', DockIcons.whatsapp({ style: dockIconSvgStyle, 'aria-hidden': 'true' }))
            ]
          )
        )
      )
