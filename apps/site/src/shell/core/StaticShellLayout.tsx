          ...
          <div class="topbar-controls">
            <div class="topbar-settings" data-open="false">
              <div
                ...
                data-state="idle"
                data-status-label-idle={copy.fragmentStatusIdle}
                data-status-label-streaming={copy.fragmentStatusStreaming}
                data-status-label-error={copy.fragmentStatusStalled}
                role="status"
                aria-live="polite"
