...
export const STATIC_SHELL_SNAPSHOT_MANIFEST_PATH = 'build/shell/core/snapshots/manifest.json'
...
export const toStaticSnapshotAssetPath = (path: string, lang: Lang) =>
  `build/shell/core/snapshots/${toStaticSnapshotAssetId(path)}.${lang}.json`
