...
describe('fragment-height-patch-runtime-loader', () => {
  it('derives the patch runtime asset URL from the static-shell script base', () => {
    ...
    expect(runtimeUrl).toBe(
      'https://prometheus.prod/build/static-shell/apps/site/src/shell/fragments/fragment-height-patch-runtime.js?v=build123'
    )
  })
  ...
  it('reuses the same import promise across repeated loads', async () => {
    ...
    const assetUrl =
      'https://prometheus.prod/build/static-shell/apps/site/src/shell/fragments/fragment-height-patch-runtime.js'
