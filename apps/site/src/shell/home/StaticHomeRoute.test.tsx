...
describe('StaticHomeRoute', () => {
  ...
  it('uses stabilized reserved heights for deferred compact cards', () => {
    ...
    expect(state?.cards.find((card) => card.id === 'fragment://page/home/react@v1')?.html).toContain('react-binary-demo')
    ...
    expect(state?.cards.find((card) => card.id === 'fragment://page/home/ledger@v1')?.html).toContain('wasm-demo')
