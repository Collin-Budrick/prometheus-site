...
describe('home-bootstrap-runtime-loader', () => {
  it('derives the runtime asset URL from the static-shell script base', () => {
    ...
    expect(runtimeUrl).toBe(
      'https://prometheus.prod/build/static-shell/apps/site/src/shell/home/home-bootstrap-anchor-runtime.js'
    )
  })
  ...
  it('reuses the same import promise across repeated loads', async () => {
    ...
    const assetUrl = 'https://prometheus.prod/build/static-shell/apps/site/src/shell/home/home-bootstrap-anchor-runtime.js'
