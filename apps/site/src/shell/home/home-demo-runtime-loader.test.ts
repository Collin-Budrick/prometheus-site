...
describe('home-demo-runtime-loader', () => {
  it('derives a kind runtime asset URL from the static-shell script base', () => {
    ...
    expect(runtimeUrl).toBe(
      'https://prometheus.prod/build/static-shell/apps/site/src/shell/home/home-demo-planner-runtime.js?v=build123'
    )
  })
  ...
  it('derives the startup attach runtime asset URL from the static-shell script base', () => {
    ...
    expect(runtimeUrl).toBe(
      'https://prometheus.prod/build/static-shell/apps/site/src/shell/home/home-demo-attach-runtime.js?v=build123'
    )
  })
  ...
  it('reuses the same import promise across repeated startup attach runtime loads', async () => {
    ...
    expect(calls).toEqual([
      'http://localhost/build/static-shell/apps/site/src/shell/home/home-demo-attach-runtime.js'
    ])
  })
  ...
  it('reuses an SSR-emitted preload link for the startup attach runtime', async () => {
    ...
    link.setAttribute('href', 'https://prometheus.prod/build/static-shell/apps/site/src/shell/home/home-demo-attach-runtime.js')
