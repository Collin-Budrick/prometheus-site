...
describe('home-language-runtime-loader', () => {
  it('derives the language runtime asset URL from the static-shell script base', () => {
    ...
    expect(runtimeUrl).toBe(
      'https://prometheus.prod/build/static-shell/apps/site/src/shell/home/home-language-runtime.js?v=build123'
    )
  })
  ...
  it('reuses the same import promise across repeated loads', async () => {
    ...
    const assetUrl =
      'https://prometheus.prod/build/static-shell/apps/site/src/shell/home/home-language-runtime.js'
