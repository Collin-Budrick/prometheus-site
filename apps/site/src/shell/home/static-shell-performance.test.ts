...
describe("static shell performance invariants", () => {
  it("keeps the home bootstrap on the fast path", async () => {
    ...
    expect(bootstrapDataSource).not.toContain("../core/language-seed-client");
    expect(bootstrapDataSource).not.toContain("resolveStaticHomeRouteSeed");
    expect(routeSeedResolverSource).toContain("../core/language-seed-client");
    ...
    expect(bootstrapSource).not.toContain("../core/snapshot-client");
    expect(bootstrapSource).not.toContain("../core/language-seed-client");
    expect(bootstrapSource).not.toContain("../auth/auth-client");
    ...
    expect(runtimeTypesSource).toContain(
      "build/static-shell/apps/site/src/shell/home/home-demo-planner-runtime.js",
    );
    expect(runtimeTypesSource).toContain(
      "build/static-shell/apps/site/src/shell/home/home-demo-react-binary-runtime.js",
    );
    ...
    expect(streamSource).toContain("../fragments/fragment-height-lock");
  ...
  it("preloads the static shell bootstrap and avoids split entry builds", async () => {
    ...
    expect(homePostAnchorCoreSource).not.toContain("../core/language-seed-client");
    expect(homeDemoWarmCoreSource).not.toContain("../core/language-seed-client");
