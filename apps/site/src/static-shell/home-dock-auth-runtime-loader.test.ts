...
describe('home-dock-auth-runtime-loader', () => {
  it('derives the dock auth runtime asset URL from the static-shell script base', () => {
    ...
    expect(runtimeUrl).toBe(
      'https://prometheus.prod/build/static-shell/apps/site/src/static-shell/home-dock-auth-runtime.js?v=build123'
    )
  })
  ...
  it('reuses the same import promise across repeated loads', async () => {
    ...
    const assetUrl =
      'https://prometheus.prod/build/static-shell/apps/site/src/static-shell/home-dock-auth-runtime.js'
