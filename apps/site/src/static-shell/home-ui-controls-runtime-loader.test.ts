...
describe('home-ui-controls-runtime-loader', () => {
  it('derives the UI controls runtime asset URL from the static-shell script base', () => {
    ...
    expect(runtimeUrl).toBe(
      'https://prometheus.prod/build/static-shell/apps/site/src/static-shell/home-ui-controls-runtime.js?v=build123'
    )
  })
  ...
  it('reuses the same import promise across repeated loads', async () => {
    ...
    const assetUrl =
      'https://prometheus.prod/build/static-shell/apps/site/src/static-shell/home-ui-controls-runtime.js'
