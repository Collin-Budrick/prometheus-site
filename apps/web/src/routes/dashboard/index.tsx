    ...
    <section class="surface p-6">
      ...
      <div class="mt-6 grid gap-4 md:grid-cols-3">
        <article class="rounded-xl border border-slate-800 bg-slate-900/60 p-4 shadow-lg shadow-slate-900/30">
          ...
          <a href="../account" class="mt-3 inline-flex text-emerald-300 hover:text-emerald-200">
            {_`Account`}
          </a>
        </article>
        <article class="rounded-xl border border-slate-800 bg-slate-900/60 p-4 shadow-lg shadow-slate-900/30">
          ...
          <a href="../settings" class="mt-3 inline-flex text-emerald-300 hover:text-emerald-200">
            {_`Settings`}
          </a>
        </article>
        <article class="rounded-xl border border-slate-800 bg-slate-900/60 p-4 shadow-lg shadow-slate-900/30">
          ...
          <div class="mt-3 flex flex-wrap gap-2">
            <a href="../chat" class="text-emerald-300 hover:text-emerald-200">
              {_`Chat`}
            </a>
            <a href="../ai" class="text-emerald-300 hover:text-emerald-200">
              {_`AI`}
            </a>
            <a href="../labs" class="text-emerald-300 hover:text-emerald-200">
              {_`Labs`}
            </a>
          </div>
        </article>
