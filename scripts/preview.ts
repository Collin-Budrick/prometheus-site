...
const spacetimeServerUri = `http://127.0.0.1:${previewSpacetimeDbPort}`
...
const webBuildExtra = {
  ...
  VITE_AUTH_BASE_PATH: composeSiteBuildEnv.VITE_AUTH_BASE_PATH,
  VITE_AUTH_SOCIAL_PROVIDERS: composeSiteBuildEnv.VITE_AUTH_SOCIAL_PROVIDERS,
  VITE_OIDC_AUTHORITY: composeSiteBuildEnv.VITE_OIDC_AUTHORITY,
  VITE_OIDC_CLIENT_ID: composeSiteBuildEnv.VITE_OIDC_CLIENT_ID,
  VITE_OIDC_JWKS_URI: composeSiteBuildEnv.VITE_OIDC_JWKS_URI,
  VITE_OIDC_POST_LOGOUT_REDIRECT_URI: composeSiteBuildEnv.VITE_OIDC_POST_LOGOUT_REDIRECT_URI,
  ...
  VITE_SPACETIMEAUTH_POST_LOGOUT_REDIRECT_URI: composeSiteBuildEnv.VITE_SPACETIMEAUTH_POST_LOGOUT_REDIRECT_URI,
...
const composeRuntimeFingerprint = computeFingerprint(
  ['docker-compose.yml', 'apps/site/Dockerfile', 'packages/platform-rs/Dockerfile', 'scripts/runtime-config.ts'],
  {
    ...
    AUTH_BASE_PATH: composeEnv.AUTH_BASE_PATH ?? '',
    AUTH_SOCIAL_PROVIDERS: composeEnv.AUTH_SOCIAL_PROVIDERS ?? '',
    VITE_AUTH_BASE_PATH: composeEnv.VITE_AUTH_BASE_PATH ?? '',
    VITE_AUTH_SOCIAL_PROVIDERS: composeEnv.VITE_AUTH_SOCIAL_PROVIDERS ?? '',
    VITE_OIDC_AUTHORITY: composeEnv.VITE_OIDC_AUTHORITY ?? '',
    VITE_OIDC_CLIENT_ID: composeEnv.VITE_OIDC_CLIENT_ID ?? '',
